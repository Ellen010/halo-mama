...
const Hero = () => {
    ...
    <div className="flex items-center flex-col gap-4">
        <img src="/product.png" alt="Halo-mama product" className="product" />
       <h1 className="flex-center mx-20 my-10 text-3xl titan-one-regular leading-loose">Here’s a short, warm welcoming message you can use on your website:
