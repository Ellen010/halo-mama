        ...
        <div className="hero-wrapper container">
            ...
            <div className="hero-text" id="product-desc">
                <h1>
                    ...
                    Born from a mom-to-be’s personal experience, this pillow was created to solve
                    a problem many expectant mothers face: finding true, all-around support as the
                    body evolves.
                </h1>
                <h1>
                    Innovatively designed to grow with you, our pregnancy pillow adapts seamlessly
                    to each trimester. Its thoughtfully engineered shape supports the belly, back,
                    hips, and legs at the same time.
                </h1>
            </div>
        </div>
    );
